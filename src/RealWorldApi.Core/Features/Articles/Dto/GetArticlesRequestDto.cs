...
{
    public static string GetCacheFingerPrint(this GetArticlesRequestDto request)
    {
        return $"p={request.Page}&l={request.Limit}&s={request.Sort}&o={request.Order}&t={request.Tag}&f={request.Favorited}&a={request.Author}";
    }
}