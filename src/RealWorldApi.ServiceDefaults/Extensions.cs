...
public static class Extensions
{
    ...
    public static WebApplication MapDefaultEndpoints(this WebApplication app)
    {
        ...
        // if (app.Environment.IsDevelopment()) // disabled if check because internal proxy has been setup in non dev environment
        {
    ...
    public static TBuilder ConfigureRateLimiting<TBuilder>(this TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
